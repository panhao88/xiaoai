      ...
      >
        ...
        <div>
          <el-form-item label="作者" prop="author">
            <el-input v-model="ruleForm.author" placeholder="请选择" style="width:150px"></el-input>
          </el-form-item>
      ...
      rules:{
        title:[
         ...
         author:[
          ...
          category:[
            {
              required:true,message:'请输入你的类目',trigger:'blur'
            }
          ],
          source:[
            {
              required:true,message:'请输入你的来源',trigger:'blur'
            }
          ],
           star:[
             {
           ...
           date:[
             {
               required:true,message:'请让老子记录你的时间',trigger:'blur'
             }
           ]
      },
       pickerOptions: {
